...
Test(cubes, the_normal_on_the_surface_of_a_cube)
	{
		...
		normal = c.normal_at(&c, new_point(-1, -0.2, 0.9));
		cr_assert(eq(dbl, normal.x, -1));
		cr_assert(eq(dbl, normal.y, 0));
		cr_assert(eq(dbl, normal.z, 0));
		normal = c.normal_at(&c, new_point(-0.4, 1, -0.1));
		cr_assert(eq(dbl, normal.x, 0));
		cr_assert(eq(dbl, normal.y, 1));
		cr_assert(eq(dbl, normal.z, 0));
		normal = c.normal_at(&c, new_point(0.3, -1, -0.7));
		cr_assert(eq(dbl, normal.x, 0));
		cr_assert(eq(dbl, normal.y, -1));
		cr_assert(eq(dbl, normal.z, 0));
		normal = c.normal_at(&c, new_point(-0.6, 0.3, 1));
		cr_assert(eq(dbl, normal.x, 0));
		cr_assert(eq(dbl, normal.y, 0));
		cr_assert(eq(dbl, normal.z, 1));
		normal = c.normal_at(&c, new_point(0.4, 0.4, -1));
		cr_assert(eq(dbl, normal.x, 0));
		cr_assert(eq(dbl, normal.y, 0));
		cr_assert(eq(dbl, normal.z, -1));
		normal = c.normal_at(&c, new_point(1, 1, 1));
		cr_assert(eq(dbl, normal.x, 1));
		cr_assert(eq(dbl, normal.y, 0));
		cr_assert(eq(dbl, normal.z, 0));
		normal = c.normal_at(&c, new_point(-1, -1, -1));
