...
Test(canvas, write_a_pixel)
{
	...
	new_canvas(&canvas, 10, 20, "Test");
	write_pixel(canvas.img, 2, 3, get_rgba(new_color(1, 0, 0, 1)));
...
Test(canvas, save_canvas_to_ppm)
{
	...
	new_canvas(&canvas, 10, 20, "Test");
	write_pixel(canvas.img, 2, 3, get_rgba(new_color(1, 0, 0, 1)));
	write_pixel(canvas.img, 4, 5, get_rgba(new_color(0, 1, 0, 1)));
	write_pixel(canvas.img, 6, 7, get_rgba(new_color(0, 0, 1, 1)));
