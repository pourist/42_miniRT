...
Test(colors, adding_colors)
{
	...
	c = add_color(color(0.9, 0.6, 0.75), color(0.7, 0.1, 0.25));
...
Test(colors, subtracting_colors)
{
	...
	c = subtract_color(color(0.9, 0.6, 0.75), color(0.7, 0.1, 0.25));
...
Test(colors, multiplying_a_color_by_a_scalar)
{
	...
	c = multiply_color(color(0.2, 0.3, 0.4), 2);
...
Test(colors, multiply_colors)
{
	...
	c = hadamard_product(color(1, 0.2, 0.4), color(0.9, 1, 0.1));
