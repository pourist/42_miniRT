...
void make_obj(char *name, t_e_obj *o, t_shape *obj, t_world *world)
{
    ...
    new_vector(ft_atof(o->axis[0]), ft_atof(o->axis[1]), ft_atof(o->axis[2]), &axis_v);
    scaling(ft_atof(o->scale[0]), ft_atof(o->scale[1]), ft_atof(o->scale[2]), &m[2]);
    calculate_rotation_matrix(&default_axis, &axis_v, &m[1]);
    translation(ft_atof(o->center[0]), ft_atof(o->center[1]), ft_atof(o->center[2]), &m[0]);
